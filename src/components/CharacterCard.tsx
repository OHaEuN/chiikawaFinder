...
export function CharacterCard({ character }: CharacterCardProps) {
  return (
    <Link href={`/characters/${character.slug}`} className="card">
      <div className="card-media contain"><SafeImage src={character.image} alt={character.name} fallback={GROUP_EMOJI[character.group]} seed={character.slug} onWhite /></div>
