...
const TILES = [
  { href: '/characters', emoji: '🐹', title: '인물 · 세계관', desc: '캐릭터 프로필과 등장 에피소드', bg: 'var(--pink)' },
  { href: '/online', emoji: '📺', title: '온라인 콘텐츠', desc: '만화 · 애니 · 나가노 작가 작품', bg: 'var(--blue)' },
  { href: '/offline', emoji: '📍', title: '오프라인 콘텐츠', desc: '팝업 · 매장 · 카페 지도', bg: 'var(--mint)' },
  { href: '/goods', emoji: '🎁', title: '굿즈 신상', desc: '최근 6개월 신상 · 콜라보', bg: 'var(--yellow)' },
];
  ...
  return (
    <>
      ...
      <section className="section-tiles">
        {TILES.map((t) => (
          <Link key={t.href} href={t.href} className="tile" style={{ background: t.bg }}>
